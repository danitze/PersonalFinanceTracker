package com.danitze.personal_finance_tracker.service.budget;

import com.danitze.personal_finance_tracker.dto.budget.BudgetLimitDto;
import com.danitze.personal_finance_tracker.dto.budget.BudgetLimitMapper;
...
public class BudgetLimitService {
    ...
    public List<BudgetLimit> getBudgetLimitsEntities(
            Long accountId
    ) {
        Account account = accountRepository.findById(accountId)
                .orElseThrow(() -> new AccountNotFoundException("Account not found"));
        return budgetLimitRepository.findAllByAccount(account);
    }
